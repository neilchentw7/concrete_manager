...
class ORMModel(BaseModel):
    """共用設定：啟用 ORM 模式供 from_orm / from_attributes 使用。"""
...
class MaterialPriceResponse(ORMModel):
    id: int
    price_id: str
    name: Optional[str]
    sand_price: float
...
class DriverAttendanceResponse(ORMModel):
    id: int
    date: date
    driver_count: int
    note: Optional[str] = None
...
class DispatchResponse(ORMModel):
    id: int
    dispatch_no: str
    date: date
    project_code: str
